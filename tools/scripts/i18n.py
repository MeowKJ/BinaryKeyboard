...
_EN: dict[str, str] = {
        ...
        "tab.info": "Info",
        "tab.studio": "Studio",
        "tab.meowisp": "BinaryKeyboard ISP",
        "tab.docs": "Docs",
        "tab.doctor": "Doctor",
        "tab.links": "Links",
        ...
        "meowisp.stack": "Stack: Rust + Slint",
        "meowisp.targets": "Targets: local BinaryKeyboard ISP build + local run",
        ...
        "action.build_meowisp": "Build BinaryKeyboard ISP",
        "action.run_meowisp": "Run BinaryKeyboard ISP",
        ...
        "hint.check_tools": "Show cmake/ninja/BinaryKeyboard ISP/toolchain detection.",
        ...
        "hint.build_meowisp": "Run cargo build for BinaryKeyboard ISP.",
        "hint.run_meowisp": "Run the BinaryKeyboard ISP desktop app from target/debug.",
        ...
        # ── ISP reference panel ───────────────────────────────────────────
        "isp.target": "target",
        "isp.meowisp": "BinaryKeyboard ISP",
...
_ZH: dict[str, str] = {
        ...
        "meowisp.stack": "技术栈: Rust + Slint",
        "meowisp.targets": "目标: 本地 BinaryKeyboard ISP 编译 + 本地运行",
        ...
        "action.build_meowisp": "编译 BinaryKeyboard ISP",
        "action.run_meowisp": "运行 BinaryKeyboard ISP",
        ...
        "hint.check_tools": "显示 cmake/ninja/BinaryKeyboard ISP/工具链检测结果。",
        ...
        "hint.build_meowisp": "为 BinaryKeyboard ISP 运行 cargo build。",
        "hint.run_meowisp": "运行 target/debug 下的 BinaryKeyboard ISP 桌面程序。",
