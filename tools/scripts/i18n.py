...
_EN: dict[str, str] = {
        ...
        "meowisp.targets": "Targets: local build + local run for CH592F-first UI",
        ...
        "action.build_meowisp": "Build MeowISP",
        "action.run_meowisp": "Run MeowISP",
        ...
        "hint.build_meowisp": "Run cargo build for tools/meowisp.",
        "hint.run_meowisp": "Run the MeowISP desktop app from target/debug.",
...
_ZH: dict[str, str] = {
        ...
        "meowisp.targets": "目标: 本地编译 + 本地运行的 CH592F 优先 UI",
        ...
        "action.build_meowisp": "编译 MeowISP",
        "action.run_meowisp": "运行 MeowISP",
        ...
        "hint.build_meowisp": "在 tools/meowisp 中运行 cargo build。",
        "hint.run_meowisp": "运行 target/debug 下的 MeowISP 桌面程序。",
