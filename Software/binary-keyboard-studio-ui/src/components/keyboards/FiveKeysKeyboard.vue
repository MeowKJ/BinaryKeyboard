<template>
    <div class="keyboard-container">
        <div class="button-grid">
            ...
            <NormalButton :index="3" :current-index="currentIndex" label="3" type="square" @click="currentIndex = 3" />
            <NormalButton :index="4" :current-index="currentIndex" label="4" type="square" @click="currentIndex = 4" />
